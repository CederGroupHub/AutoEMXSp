...
results_path : str, optional
    Directory where results are stored. If None, sets to default AutoXsp/Results
...
from autoxsp.tools.utils import (
...
from autoxsp.tools.config_classes import config_classes_dict
...
def analyze_sample(
    ...
    sample_ID : str
        Sample identifier.
    results_path : str, optional
        Directory where results are loaded and stored. If None, defaults to AutoXSp/Results
    output_filename_suffix : str, optional
        Suffix for output files.
    ref_formulae : list of str, optional
        Reference formulae for clustering.
